					...
					<div class="h-c-2f">
						...
						<div class="s-f1">
							<div class="yhtx">
                                      ...
                                      <?php else: ?>
                                      	<img src="/matouPCS/Public/upload/<?php echo ($user["pubtime"]); ?>/<?php echo ($user["imagename"]); ?>"   style="width: 137px; height: 144px;border-radius:50%"/><?php endif; ?>
								<div class="vip">
						...
						<div class="s-f2">
							...
							<p style="text-align: center;">
								<?php if($user[bdlx]==1): ?>（个人部队）
								<?php elseif($user[bdlx]==2): ?>
								（婚庆公司）
								<?php elseif($user[bdlx]==3): ?>
								（工作室）
								<?php elseif($user[bdlx]==4): ?>
								（影楼）
								<?php elseif($user[bdlx]==5): ?>
								（表演团）
								<?php else: ?>
								（商铺部队）<?php endif; ?>
							</p>
										...
										$.ajax({
											...
											//	alert(2);
												...
												for (var i = 0; i < data.length; i++) {
													...
													li+='<li><div class="left">'+url+'<div class="vip"><img src="/matouPCS/Public/Home/img/rzlogo.png" /></div></div><div class="right"><p class="tt"><span style="float: left;"><a href="">用户'+use+'</a></span><span style="float: right; text-align: right;">'+data[i].addre+'</span></p><p class="grjj">'+data[i].content+'</p><div class="bottom"><p class="sj">'+data[i].time+'</p><p onclick="zan('+data[i].lid+','+data[i].zan+')" class="dz dz-qx">'+dianzan+'</span><span style="font-size: 17px;" id="s'+data[i].lid+'">'+data[i].zan+'</span></p></div></div><div class="clearfloat"></div></li>';
												};
												$('#li').html(li);
												$('#contents').val('');
											},error:function(){
