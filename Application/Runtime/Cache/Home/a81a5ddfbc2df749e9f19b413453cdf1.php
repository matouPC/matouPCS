...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title>求购详情</title>
		<link rel="stylesheet" href="/matouPCS/Public/Home/css/xqqg-3r-zy.css" />
		...
		<section>
			<div class="s-main-c">
				...
				<div class="s-main-l">
					...
					<div class="s-c-2f" style="border-bottom: 0px; height: auto!important;">
						<div class="s-2f-c1">
							<span class="hfx"></span>
							<p><strong>求购物品</strong></p>
						</div>
						
						<div class="xqwc">
							<div class="xqcc">
								<p class="xqcc-c">
									<span class="xqcc-c0">物品名称：</span><span class="xqcc-c3"><?php echo ($list["name"]); ?></span><span class="xqcc-c1">价格：</span><span class="xqcc-c3">￥<?php echo ($list["price"]); ?></span>
								</p>
								<p class="xqcc-c"><span class="xqcc-c0">具体要求：</span><span class="xqcc-c2"><?php echo ($list["content"]); ?>...</span></p>
							</div>
							<?php $bao = explode(',',$list['bao']); array_pop($bao); $num = count($bao); ?>
								  <?php if(in_array($_SESSION['id'],$bao)){ ?>
									  <div class="xqbta"  style="background:#ccc;font-size:12px;" id="bt-p">
