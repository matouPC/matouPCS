...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title>认证部队</title>
		<link rel="stylesheet" href="/matouPCS/Public/Home/css/rzbddnly-3r-xy.css" />
					...
					<div class="h-c-2f">
						...
						<div class="s-f2">
							...
							<div>
								...
								<span style="display: block; float: left;"><?php echo ($bu["fen"]); ?></span>
							</p>
							<p class="szd">
							...
							<div class="s-c-2f-2f">
								<div class="jbxx">
									...
									<ul class="right">
										...
										<li>
											<span class="tel"><?php echo ($bu["tels"]); ?></span><input type="hidden" id="xp" value="<?php echo ($bu["tels"]); ?>">
