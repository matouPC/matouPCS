		...
		<script src="http://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js"></script>
						...
						<div class="h-c-3f">
							...
							<div class="s-f2">
								...
								<div>
									<p class="fsl">
										<span class="icon-fs"></span> <?php echo ($bu["fen"]); ?>
									</p>
									<p class="szd">
			...
			$.ajax({
				...
				success:function(data){
      			 ...
      			 for (var i = 0; i < data.length; i++) {
					...
					var p ='<div id="ha">'+li+'</div><div class="s-main-b"><div class="margin"><button onclick="tj1(<?php echo ($_GET['id']); ?>)" name="btnn" id="btnn" >点击加载更多</button></div></div>';
					$('#re').html(p);
					//$('#re').val('');
				},error:function(){
					alert('no');
