...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title>应赏详情页</title>
		<link rel="stylesheet" href="/matouPCS/Public/Home/css/ysxqwc-3r-zy.css" />
			...
			<div class="h-content-main">
				<div class="h-main-c">
					...
					<div class="h-c-3f">
						...
						<a href="?s=/Home/Ysq/xqys/id/<?php echo ($id); ?>">
							<div class="h-f3-c1">查看应赏详情页</div>
						</a>
					</div>
				</div>
			</div>
		...
		<section>
			<div class="s-main-c">
				<div class="s-main-r">
					<div class="s-c-1f">
						<a href="?s=/Home/Xsdt">
							<img src="/matouPCS/Public/Home/img/jrxsdt.png" />
						</a>
					</div>
							...
							<?php if(is_array($list)): foreach($list as $key=>$lists): ?><li>
								<a href="">
									<div>
										...
										<!--<p class="hdsj"></p>-->
										<!--<p class="hdsj">部队类型：</p>-->
										<p class="hddd">活动地点：<?php echo ($lists["addre"]); ?></p>
									...
									<div class="details">
										<?php if(is_array($data)): foreach($data as $key=>$datas): if($lists['psid'] == $datas['pid']){ ?>
												...
												<p class="age"><span class="xqcc-c0"><?php echo ($datas["age"]); ?>岁</span></p>
												<p class="jtyq"><span class="xqcc-c0">具体要求：</span><?php echo ($datas["yaoqiu"]); ?></p>
			...
			<div class="f-main-c">
				<!--<div class="f-c-1f">
					...
					<ul>
						...
						<li>
							<img style="margin-left: 45px;" src="../ 码头2/img/erweima_bottom.png" />
						</li>
