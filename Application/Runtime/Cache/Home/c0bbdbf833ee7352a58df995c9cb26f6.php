    ...
    <div id="wrap">
        ...
        <div class="regbox" style=" display:  none" >
            <form>
                ...
                <div class="ttbox"><input type="text" name="name" id='name'value="姓名" onblur="if (this.value == '') {
                            this.value = '姓名'
                        }" onfocus="if (this.value == '姓名') {
                                    this.value = ''
                                }" /></div>
                <div class="ttbox"><input type="text" name="phone" id='phone'value='电话' onblur="if (this.value == '') {
                    this.value = '电话'
                }" onfocus="if (this.value == '电话') {
                            this.value = ''
                        }" /></div>
