							...
							<div class="s-c-3f-2f-f">
								<ul>
									<li>
										<div class="na2">
											<div class="picture1">
												<img id="pic1" src="<?php echo '/matouPCS/Uploads/'.$fbyp_jl_v[0]; ?>">
										...
										<div class="input-h">
											<div class="input-bt">
												<input type="text" name="title1" value="<?php echo $fbyp_jl_t[0] ?>" placeholder="请输入视频标题" />
											</div>
											<div class="input-dz">
									...
									<li>
										<div class="na2">
											<div class="picture2">
												<img id="pic2" src="<?php echo '/matouPCS/Uploads/'.$fbyp_jl_v[1]; ?>">
										...
										<div class="input-h">
											<div class="input-bt">
												<input type="text" name="title2" value="<?php echo $fbyp_jl_t[1] ?>" placeholder="请输入视频标题" />
											</div>
											<div class="input-dz">
									...
									<li style="margin: 0;">
										<div class="na2">
											<div class="picture3">
												<img id="pic3" src="<?php echo '/matouPCS/Uploads/'.$fbyp_jl_v[2]; ?>">
										...
										<div class="input-h">
											<div class="input-bt">
												<input type="text" name="title3" value="<?php echo $fbyp_jl_t[2] ?>" placeholder="请输入视频标题" />
											</div>
											<div class="input-dz">
