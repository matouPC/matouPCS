						...
						<ul>
							<?php if(is_array($datan)): foreach($datan as $key=>$dataa): ?><li>
								<a href="?s=/Home/Zpdt1/xqzp/id/<?php echo ($dataa["rid"]); ?>">
									<div>
										<div class="yh-admin">
										 <?php if($dataa[imagename]==''): ?><img src="/matouPCS/Public/Home/img/tjzp_01.png" />
                                      <?php else: ?>
                                      	<img src="/matouPCS/Tu/upload/<?php echo ($dataa["imagename"]); ?>"  style="border-radius:50%"/><?php endif; ?>
										...
										<div class="s-r-5f-right">
											...
											<div class="clear"></div>
											<div class="s-r-5f-2f">
												<p><?php echo ($dataa["type"]); ?></p>
												<if condition="$$dataa[sex]=='1'">
												<p><?php echo ($dataa["sex"]); ?></p>
												<p><?php echo ($dataa["age"]); ?></p>
												<div class="clear"></div>
											</div>
											<p class="xz">
												薪资：<span class="red"><?php echo ($dataa["price"]); ?>/月</span>
											</p>
										</div>
										<div class="clear"></div>
									</div>
