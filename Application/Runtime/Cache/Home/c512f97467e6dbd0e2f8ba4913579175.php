					...
					<div class="s-c-2f">
						...
						<div class="s-2f-c2">
							...
							<div class="c2-ct21">
								...
								<p id="spdl-p"><span class="xqcc-c0">联系电话：</span><span class="xqcc-c3"><?php echo (substr($list["rtel"],0,3)); ?>XXXX<?php echo (substr($list["rtel"],8,11)); ?></span></p><button id="sp">查看号码 </button>
