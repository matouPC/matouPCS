...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title>招聘详情</title>
		<link rel="stylesheet" href="/matouPCS/Public/Home/css/xqzp-3r-zy.css" />
				...
				<div class="s-main-l">
					<div class="s-c-2f">
						...
						<div class="s-2f-c2">
							<div class="c2-ct1">
								...
								<p><span class="xqcc-c0">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：</span><span class="xqcc-c3"><?php echo ($list["remail"]); ?></span></p>
							</div>
							<div class="c2-ct2">
								<p><span class="xqcc-c0">QQ号码：</span><span class="xqcc-c3"><?php echo ($list["rqq"]); ?></span></p>
								<p id="spdl-p"><span class="xqcc-c0">联系电话：</span><span class="xqcc-c3"><?php echo (substr($list["rtel"],0,3)); ?>XXXX<?php echo (substr($list["rtel"],8,11)); ?></span></p><button id="sp">查看号码 </button><input type="hidden" id="xp" value="<?php echo ($list["rtel"]); ?>">
							</div>
						</div>
						<br>
					</div>
					<div class="s-c-2f" style="border-bottom: 0px!important;">
						...
						<!-- <div class="xqwc">
							<div class="xqcc">
								<p class="xqcc-c">
									<span class="xqcc-c0">招聘职位：</span><span class="xqcc-c3">摄影师</span><span class="xqcc-c1">薪资：</span><span class="xqcc-c3">3000-6000元/月</span>
								</p>
								<p class="xqcc-c">
									<span class="xqcc-c0">性别：</span><span class="xqcc-c3">女</span><span class="xqcc-c1">年龄：</span><span class="xqcc-c3">25岁</span><span class="xqcc-c1">工作年龄：</span><span class="xqcc-c3">1-2年</span>
								</p>
								<p class="xqcc-c"><span class="xqcc-c0">工作内容：</span><span class="xqcc-c2">岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求...</span></p>
								<br>
								<p class="xqcc-c"><span class="xqcc-c0">岗位要求：</span><span class="xqcc-c2">岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求岗位要求...</span></p>
							</div>
							<div class="xqbtb">
								<a href="#">招聘结束</a>
							</div>
