		...
		<section>
			<div class="s-main-c">
				<div class="s-main-l">
					...
					<div class="s-c-3f" >
						<div class="s-c-2f-2f" id='ajax_lists'>
						</div>
					</div>
				</div>
				<div class="s-main-r">
						...
						<ul>
							<?php if(is_array($listn)): foreach($listn as $key=>$listns): ?><li>
								...
								<?php if($listns[imagename]==''): ?><img src="/matouPCS/Public/Home/img/bdmc.png" width="101" height="101">
                                   <?php else: ?>
                                     <img style="border-radius:50%;width: 101px;height:101"  src="/MatouPCS/Tu/upload/<?php echo ($listns["imagename"]); ?>"  /><?php endif; ?>
										...
										<div>
											<p class="tj_01_04">
												...
												<span class="text36"><?php echo ($listns["content"]); ?>	</p>
										</div>
									</div>
								</a>
							</li><?php endforeach; endif; ?>
