			...
			<div class="s-main-c">
				...
				<div class="wk_01">
					<div class="con">
						<div class="s-main-b">
							<ul>
								<?php if(is_array($fbxz)): foreach($fbxz as $key=>$fbxzs): ?><li>
											<div class="yfb">
												<a href="?s=/Home/Tzsc/xqxz/id/<?php echo ($fbxzs["fid"]); ?>">
												<div class="yfb_01">
													<p class="yfb_01_01">物品名称：<b><?php echo ($fbxzs["name"]); ?></b></p>
													<p class="yfb_01_02">预算：<b>￥<?php echo ($fbxzs["price"]); ?>元</b></p>
													<p class="yfb_01_03">
														<?php
 if($fbxzs['tz_status'] == '1'){ ?>
														<button class="tj_01_03" id="btn<?php echo ($fbxzs["fid"]); ?>">未出售</button>
														<?php }else{ ?>
														<button class="tj_01_03" id="btn<?php echo ($fbxzs["fid"]); ?>">已出售</button>
														<?php } ?>
												...
												<div class="xialai">
													...
													<?php
 if($fbxzs['tz_status'] == '1'){ ?>
														<p class="xs1" onclick="wan(<?php echo ($fbxzs["fid"]); ?>)" id="w<?php echo ($fbxzs["fid"]); ?>" style="font-size: 12px;">完成</p>
														<?php }else{ ?>
														<p class="xs1" onclick="wan(<?php echo ($fbxzs["fid"]); ?>)" id="w<?php echo ($fbxzs["fid"]); ?>" style="font-size: 12px;">删除</p>
														<?php } ?>
												</div>
												<div class="yfb_01" style="margin-top:24px;">
													<?php $shou = explode(',',$fbxzs['shou']); array_pop($shou); $shou_num = count($shou); ?>
													<p class="yfb_01_04">已有<?php echo ($shou_num); ?>人收藏</p>
													<p class="yfb_sj">发布时间：<?php echo ($fbxzs["date"]); ?></p>
												</div>
											</div>
											<div class="yfb_img">
											</div>
