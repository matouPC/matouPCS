			...
			<div class="s-main-c">
					...
					<div class="userin">
						<div class="u-img">
							<?php if($_SESSION['id'] == $list['uid']){ ?>
								<?php if($list[bdlx]=='1'): ?><a href="?s=/Home/Mtbu/grbddndt/id/<?php echo ($list["uid"]); ?>"><img src="/matouPCS/Tu/upload/<?php echo ($list["imagename"]); ?>" /></a>
								<?php elseif($list[bdlx]=='6'): ?>
								<a href="?s=/Home/Mtbu/spbddndt/id/<?php echo ($list["uid"]); ?>"><img src="/matouPCS/Tu/upload/<?php echo ($list["imagename"]); ?>" /></a>
								<?php else: ?>
								<a href="?s=/Home/Mtbu/rzbddndt/id/<?php echo ($list["uid"]); ?>"><img src="/matouPCS/Tu/upload/<?php echo ($list["imagename"]); ?>" /></a><?php endif; ?>
									<?php }else{ ?>
                                        <?php if($list[bdlx]=='1'): ?><a href="?s=/Home/Mtbu/grbddydt/id/<?php echo ($list["uid"]); ?>"><img src="/matouPCS/Tu/upload/<?php echo ($list["imagename"]); ?>" /></a>
								<?php elseif($list[bdlx]=='6'): ?>
								<a href="?s=/Home/Mtbu/spbddydt/id/<?php echo ($list["uid"]); ?>"><img src="/matouPCS/Tu/upload/<?php echo ($list["imagename"]); ?>" /></a>
								<?php else: ?>
								<a href="?s=/Home/Mtbu/rzbddydt/id/<?php echo ($list["uid"]); ?>"><img src="/matouPCS/Tu/upload/<?php echo ($list["imagename"]); ?>" /></a><?php endif; ?>
                                <?php } ?>
						</div>
						<div class="u-cont">
						...
						<p class="tfs14"><strong><a href="#"><?php if($list[username]==$list[tel]): ?>用户<?php echo (substr($list["username"],0,5)); endif; ?>
							...
							<p class="tfs12">职位：<?php echo ($list["type_d"]); ?></p>
							<?php  $add = explode(',',$list['address']); ?>
							<p class="tfs12">所在地：<?php echo ($add[0]); ?></p>
							<?php if($_SESSION['id'] == $list['uid']){ ?>
								...
								<a href="?s=/Home/Mtbu/rzbddydt/id/<?php echo ($list["uid"]); ?>"><button>进入Ta的主页</button></a><?php endif; ?>
                                       <?php } ?>
							<!-- <button onclick="window.location = 'grbddydt-3r-xy.php'">进入Ta的主页</button> -->
						</div>
					</div>
				...
				<div class="s-main-l">
					<div class="s-c-2f">
						...
						<div class="s-2f-c2">
							<div class="c2-ct1">
								<p><span class="xqcc-c0">姓<samp class="kog12"></samp>名：</span><span class="xqcc-c3"><?php echo ($list["name"]); ?></span></p>
								<p><span class="xqcc-c0">性<samp class="kog12"></samp>别：</span><span class="xqcc-c3"><?php echo ($list["sexs"]); ?></span></p>
								<p><span class="xqcc-c0">年<samp class="kog12"></samp>龄：</span><span class="xqcc-c3"><?php echo ($list["age"]); ?>岁</span></p>
								<p><span class="xqcc-c0">地<samp class="kog12"></samp>区：</span><span class="xqcc-c3"><?php  $add = explode(',',$list['address']); echo $add[0];?></span></p>
							</div>
							<div class="c2-ct21">
								<p><span class="xqcc-c0">QQ号码：</span><span class="xqcc-c3"><?php echo ($list["qqs"]); ?></span></p>
								<p id="spdl-p"><span class="xqcc-c0">联系电话：</span><span class="xqcc-c3"><?php echo (substr($list["tels"],0,3)); ?>XXXX<?php echo (substr($list["tels"],8,11)); ?></span><button id="sp">查看号码</button></p><input type="hidden" id="xp" value="<?php echo ($list["tels"]); ?>">
								<p><span class="xqcc-c0">期望职业：</span><span class="xqcc-c3"><?php echo ($list["type_d"]); ?></span></p>
								<p><span class="xqcc-c0">期望薪资：</span><span class="xqcc-c3"><?php echo ($list["price"]); ?>k/月</span></p>
							</div>
							<div class="clear"></div>
							<div class="c2-ct3">
								<p>自我介绍：</p>
								<p class="s-2f-c3-1-gzqb"><span class="xqcc-c3"><?php echo ($list["content"]); ?></span></p>
							</div>
							<div class="clear"></div>
							<div class="c2-ct3">
								<p>擅长婚礼类型：</p>
								<p class="s-2f-c3-1-gzqc"><span class="xqcc-c3"><?php echo ($list["skilled"]); ?></span></p>
							</div>
							<div class="clear"></div>
						</div>
					...
					<div class="s-c-2f">
						...
						<div class="s-2f-c2">
							...
							<ul class="u-p">
								...
								<li>
									<a rel="gallery" class="boxer" href="img/xj.png">
										<img src="<?php echo '/matouPCS/Uploads/'.substr($zuo[$i],1); ?>" alt="" />
									</a>
								</li>
								<?php } ?>
					...
					<div class="s-c-2f">
						...
						<div class="s-2f-c2">
							<ul class="u-v">
								...
								<li>
									<a href="#">
										<img style="width:260px;height:280px;" src="<?php echo "/matouPCS/Uploads/".substr($tit_img[$i],1);?>" alt="" />
									</a>
					...
					<div class="s-c-4f-2">
						...
						<?php }else{ ?>
							<?php if($_SESSION['id'] == ''){ ?>
								<div class="s-tf-btn" style="margin-left: 5px;" onclick="alert('请先登录')" id="bt-sc">
							<?php }else{ ?>
								<div class="s-tf-btn" style="margin-left: 5px;" onclick="shou(<?php echo ($list["did"]); ?>)" id="bt-sc">
							<?php } ?>
								<p>收藏
								</p>
								<img src="/matouPCS/Public/Home/img/sc.png" style="top: 10px;">
							</div>
						<?php } ?>
						<div class="clearfloat "></div>
					</div>
