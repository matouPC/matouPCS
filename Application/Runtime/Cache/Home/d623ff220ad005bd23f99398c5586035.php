	...
	<script>
		...
		<script src="http://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js"></script>
					...
					<div class="h-c-3f">
						...
						<a href="#">
							<a href="?s=/Home/Tzsc/xqqg/id/<?php echo ($id); ?>" class="h-f3-c1">查看求购详情页</a>
						</a>
					</div>
				</div>
			</div>
		...
		<section>
			<div class="s-main-c">
				<div class="s-main-r">
					<div class="s-c-1f">
						<a href="?s=/Home/Tzsc">
							<img src="/matouPCS/Public/Home/img/jrtssc.png" alt="" />
						</a>
					</div>
				</div>
				<div class="s-main-l">
					<div class="s-c-3f">
						<div class="user">
							<?php if(is_array($list)): foreach($list as $key=>$lists): ?><div class="user_01">
									<a href="?s=/Home/Tzsc/xqxz/id/<?php echo ($lists["fid"]); ?>">
										<div class="xztp">
											<img src="/matouPCS/Public/Home/img/yhmc-big.png" alt="">
										</div>
										<div class="user_01_01">
											...
											<?php $shou = explode(',',$lists['shou']); array_pop($shou); $shou_num = count($shou); ?>
											<p class="user_01_04">已有<?php echo ($shou_num); ?>人收藏</p>
							...
							<!-- <div class="user_01">
								<a href="#">
									<div class="user_02">
										<div class="wptp">
											<img src="img/bdmc.png" alt="">
										</div>
										<p>闲置：音响</p>
										<div class="clearfloat"></div>
									</div>
									<div class="user_01_01b">
										<div class="user_01_02">
											<p>音响</p><span>预算￥500元</span></div>
										<p class="user_01_03b">商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍</p>
										<p class="user_01_04">已有20人收藏</p>
										<p class="user_01_05">郑州</p>
										<div class="clearfloat"></div>
									</div>
								</a>
							</div>
							...
							<div class="user_01">
								<a href="#">
									<div class="xztp">
										<img src="img/yhmc-big.png" alt="">
									</div>
									<div class="user_01_01">
										<div class="user_01_02">
											<p>闲置：音响</p><span>￥500元</span></div>
										<p class="user_01_03">商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍。。。商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍商品介绍。。。</p>
										<p class="user_01_04">已有20人收藏</p>
										<p class="user_01_05">郑州</p>
									</div>
								</a>
