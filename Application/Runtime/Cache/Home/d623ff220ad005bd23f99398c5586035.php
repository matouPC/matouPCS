...
<html>
	...
	<head>
		<meta charset="UTF-8">
		<title>发布求购</title>
		<link rel="stylesheet" href="/matouPCS/Public/Home/css/qgfbwc-3r-zy.css" />
			...
			<div class="h-content-main">
				<div class="h-main-c">
					...
					<div class="h-c-3f">
						...
						<a href="?s=/Home/Tzsc/xqqg/id/<?php echo ($id); ?>"><div class="h-f3-c1">查看求购详情页</div></a>
		...
		<section>
			<div class="s-main-c">
				<div class="s-main-r">
					<div class="s-c-1f">
						<a href="?s=/Home/Tzsc">
							<img src="/matouPCS/Public/Home/img/jrtssc.png" />
						</a>
					</div>
								...
								<a href="?s=/Home/Tzsc/xqxz/id/<?php echo ($lists["fid"]); ?>">
									...
									<div class="user_01_01">
										<div class="user_01_02">
											<p>闲置：<?php echo ($lists["name"]); ?></p><span>￥<?php echo ($lists["price"]); ?>元</span></div>
