				...
				<div class="s-main-r">
					<div class="userin">
						<div class="u-img">
								...
								<a href="?s=/Home/Mtbu/rzbddndt/id/<?php echo ($list["uid"]); ?>"><?php endif; ?>
									<?php }else{ ?>
                                        <?php if($list[bdlx]=='1'): ?><a href="?s=/Home/Mtbu/grbddydt/id/<?php echo ($list["uid"]); ?>">
								<?php elseif($list[bdlx]=='6'): ?>
								<a href="?s=/Home/Mtbu/spbddydt/id/<?php echo ($list["uid"]); ?>">
								<?php else: ?>
								<a href="?s=/Home/Mtbu/rzbddydt/id/<?php echo ($list["uid"]); ?>"><?php endif; ?>
                                       <?php } ?>
                                      <?php if($list[imagename]==''): ?><img src="/matouPCS/Public/Home/img/tx2-3r.png" />
                                   <?php else: ?>
                                      <img src="/matouPCS/Tu/upload/<?php echo ($list["imagename"]); ?>" /><?php endif; ?>
                                   </a>  
						</div>
						<div class="u-cont">
							<p class="tfs14"><strong>
							 <?php if($list[username]==$list[tel]): ?>用户<?php echo (substr($list["username"],0,5)); endif; ?>
								               <?php if($list[username]!=$list[tel]): ?>用户<?php echo ($list["username"]); endif; ?>
								                  </strong></p>
							<p class="tfs12">职位：<?php echo ($list["type_u"]); ?></p>
							<p class="tfs12">所在地：<?php echo ($list["address"]); ?></p>
						  	<?php if($_SESSION['id'] == $list['uid']){ ?>
					...
					<div class="s-c-2f">
						...
						<div class="s-2f-c2">
							<div class="c2-ct1">
								...
								<p><span class="xqcc-c0">邮<samp class="kog14"></samp>箱：</span><span class="xqcc-c3">暂无</span></p>
							</div>
							<div class="c2-ct21">
					...
					<div class="s-c-2fb">
						...
						<div class="xqwc">
							<div class="xqcc">
								...
								<p class="xqcc-c">
									<span class="xqcc-c0">性别：</span><span class="xqcc-c3"><?php echo ($listNews["sex"]); ?>岁</span><span class="xqcc-c1">年龄：</span><span class="xqcc-c3"><?php echo ($listNews["age"]); ?>岁</span><span class="xqcc-c1">工作经验：</span><span class="xqcc-c3">1-2年</span><span class="xqcc-c1">报销路费：</span><span class="xqcc-c3">
									  <?php if($listNews[whether]=='1'): ?>否
									  <?php else: ?>
									  是<?php endif; ?>
									</span>
								</p>
