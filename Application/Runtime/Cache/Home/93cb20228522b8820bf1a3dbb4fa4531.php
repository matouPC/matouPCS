		...
		<script src="/matouPCS/Public/Home/js/header-index.js"></script>
					...
					<div class="s-f2">
						...
						<div>
								...
								<a style="color: #FF5C5D;" href="?s=/Home/Mtbu/spbddnxq/id/<?php echo ($_GET['id']); ?>">需求</a>
					...
					<!--<div class="h-c-3f">
						...
						<a href="#"><div class="h-f3-c1">btnn</div></a>
										...
										<div class="word">
											...
											<p>
												<span class="word-jtyq">
													<strong style="font-weight: 400; color: #333;">具体要求：</strong>
		...
		if(where=='z'||where=='r'){
			$.ajax({
				...
				//	alert(data);
					...
					//	var p1='<div class="s-c-3f"><ul id="shiyan">'+xxoo+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj(<?php echo ($_GET['id']); ?>)" name="btnn" id="btnn">点击加载更多</button></div></div>'
					...
					//	var pq='<div class="s-c-3f"><ul id="ys">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button  onclick="tj1(<?php echo ($_GET['id']); ?>)" name="btnn1" id="btnn1">点击加载更多</button></div></div>'		
					...
					//	var p1='<div class="s-c-3f"><ul id="zp">'+xxoo+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj2(<?php echo ($_GET['id']); ?>)" name="btnn2" id="btnn2">点击加载更多</button></div></div>'
						...
						//var p='<div class="s-c-3f"><ul id="yp">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj3(<?php echo ($_GET['id']); ?>)" name="btnn3" id="btnn3">点击加载更多</button></div></div>		
					...
					//	var p='<div class="s-c-3f"><ul id="qg">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj4(<?php echo ($_GET['id']); ?>)" name="btnn4" id="btnn4">点击加载更多</button></div></div>'	
			...
			$.ajax({
				...
				success:function(data){
                   var xxoo='';
					...
					var p1='<div class="s-c-3f"><ul id="shiyan">'+xxoo+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj(<?php echo ($_GET['id']); ?>,1)" name="btnn" id="btnn">点击加载更多</button></div></div>'
					$('#ul').html(p1);
					$('#content').val('');
				},error:function(){
					alert('no');
			...
			//alert(1);								
				$.ajax({
					...
					success:function(data){
						...
						var p='<div class="s-c-3f"><ul id="ys">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button  onclick="tj1(<?php echo ($_GET['id']); ?>,1)" name="btnn1" id="btnn1">点击加载更多</button></div></div>'
				...
				$.ajax({
					...
					success:function(data){
                     ...
                     var xxoo='';
						...
						var p1='<div class="s-c-3f"><ul id="zp">'+xxoo+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj2(<?php echo ($_GET['id']); ?>,1)" name="btnn2" id="btnn2">点击加载更多</button></div></div>'
						$('#ul').html(p1);
						$('#content').val('');
					},error:function(){
						alert('no');
			...
			//	alert(1);
					...
					$.ajax({
						...
						//	alert(2);
							...
							var p='<div class="s-c-3f"><ul id="yp">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj3(<?php echo ($_GET['id']); ?>,1)" name="btnn3" id="btnn3">点击加载更多</button></div></div>'
							$('#ul').html(p);
							$('#content').val('');
						},error:function(){
							alert('no');
								...
								//	alert(1);
										...
										$.ajax({
											...
											success:function(data){
												...
												var p='<div class="s-c-3f"><ul id="qg">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj4(<?php echo ($_GET['id']); ?>,1)" name="btnn4" id="btnn4">点击加载更多</button></div></div>'
												$('#ul').html(p);
												$('#content').val('');
											},error:function(){
												alert('no');
								...
								//	alert(1);
										...
										$.ajax({
											...
											success:function(data){
												...
												var p='<div class="s-c-3f"><ul id="xz">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj5(<?php echo ($_GET['id']); ?>,1)" name="btnn5" id="btnn5">点击加载更多</button></div></div>'
												$('#ul').html(p);
												$('#content').val('');
											},error:function(){
												alert('no');
									...
									$.ajax({
										...
										success:function(data){
						                   ...
						                   var xxoo='';
											...
											var p1='<div class="s-c-3f"><ul id="shiyan">'+xxoo+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tjc(<?php echo ($_GET['id']); ?>,2)" name="btnn" id="btnn">点击加载更多</button></div></div>'
											$('#ul').html(p1);
											$('#content').val('');
										},error:function(){
											alert('no');
								...
								//	alert(1);								
										$.ajax({
											...
											//	alert(2);
												...
												var p='<div class="s-c-3f"><ul id="ys">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button  onclick="tj1c(<?php echo ($_GET['id']); ?>,2)" name="btnn1" id="btnn1">点击加载更多</button></div></div>'
												$('#ul').html(p);
												$('#content').val('');
											},error:function(){
												alert('no');
										...
										$.ajax({
											...
											success:function(data){
						                     ...
						                     var xxoo='';
												...
												var p1='<div class="s-c-3f"><ul id="zp">'+xxoo+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj2c(<?php echo ($_GET['id']); ?>,2)" name="btnn2" id="btnn2">点击加载更多</button></div></div>'
												$('#ul').html(p1);
												$('#content').val('');
											},error:function(){
												alert('no');
									...
									//	alert(1);
											...
											$.ajax({
												...
												//	alert(2);
													...
													var p='<div class="s-c-3f"><ul id="yp">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj3c(<?php echo ($_GET['id']); ?>,2)" name="btnn3" id="btnn3">点击加载更多</button></div></div>'
													$('#ul').html(p);
													$('#content').val('');
												},error:function(){
													alert('no');
														...
														//	alert(1);
																...
																$.ajax({
																	...
																	success:function(data){
																		...
																		var p='<div class="s-c-3f"><ul id="qg">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj4c(<?php echo ($_GET['id']); ?>,2)" name="btnn4" id="btnn4">点击加载更多</button></div></div>'
																		$('#ul').html(p);
																		$('#content').val('');
																	},error:function(){
																		alert('no');
														...
														//	alert(1);
																...
																$.ajax({
																	...
																	success:function(data){
																		...
																		var p='<div class="s-c-3f"><ul id="xz">'+li+'</ul></div><div class="s-main-b"><div class="margin"><button onclick="tj5c(<?php echo ($_GET['id']); ?>,2)" name="btnn5" id="btnn5">点击加载更多</button></div></div>'
																		$('#ul').html(p);
																		$('#content').val('');
																	},error:function(){
																		alert('no');
				...
				success:function(data){
					...
					if(data!=null){				
						...
						var li = '';
						 ...
						 //alert(22);
						 document.getElementById('btnn3').innerHTML = '加载完毕';
		 				flag=true;	
					}	
		 },
		 	complete:function(){
				...
				$.ajax({
					...
					success:function(data){
						...
						$("#qg").append(li);
							 ...
							 //alert(22);
							 document.getElementById('btnn4').innerHTML = '加载完毕';
			 				flag=true;	
						}	
			 },
			 	complete:function(){
					...
					success:function(data){
						...
						if(data!=null){				
							...
							for (var i = 0; i < data.length; i++) {
							 ...
							 //alert(22);
							 document.getElementById('btnn5').innerHTML = '加载完毕';
			 				flag=true;	
						}	
			 },
			 	complete:function(){
