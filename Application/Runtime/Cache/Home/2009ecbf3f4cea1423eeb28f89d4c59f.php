	...
	<script>
		...
		<script src="http://res.wx.qq.com/connect/zh_CN/htmledition/js/wxLogin.js"></script>
						...
						<div class="h-c-3f">
							...
							<a href="#">
								<a href="?s=/Home/Zpdt/xqyp/id/<?php echo ($id); ?>" class="h-f3-c1">查看应聘详情页</a>
							</a>
						</div>
				</div>
			</div>
		...
		<section>
			<div class="s-main-c">
				<div class="s-main-r">
					<div class="s-c-1f">
						<a href="?s=/Home/Zpdt1/index/type/0">
									...
									<a href="">
										<div>
											<div class="tx">
			                                   ...
			                                   <?php else: ?>
			                                     	<img style="width:50px;" src="/MatouPCS/Tu/upload/<?php echo ($lists["imagename"]); ?>" alt="" /><?php endif; ?>
										...
										<div>
											...
											<p class="sjfb"><?php echo ($lists["date"]); ?></p>
											<div class="clearfloat"></div>
										</div>
									</a>
