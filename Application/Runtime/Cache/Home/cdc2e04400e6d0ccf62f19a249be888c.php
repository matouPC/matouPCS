							...
							<ul class="tyint">
								<li>
									<div class="mmap">
										...
										<div class="litr">
											<input type="text" class="w200t" id="xz-city" placeholder="请选择所在地" name="add" eadonly="readonly" value="" data-value="" onclick="appendCity(this,'danxuan')">
										</div>
										<div class="cf"></div>
									</div>
								</li>
								...
								<li>
									<div class="memail">
										...
										<div class="litr"><input class="w200t" name="tel"  type="text" /></div>
										<div class="cf"></div>
									</div>
								</li>
								<li>
