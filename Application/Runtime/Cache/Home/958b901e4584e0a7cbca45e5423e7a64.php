				...
				<div class="s-main-r">
					...
					<div class="cjsp_bt">
						<ul>
							...
							<li class="cjsp_bt_03">
								<a href="#"><img src="/matouPCS/Public/Home/img/r_01.png" width="20" height="20">&nbsp;&nbsp;创建成功</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
						</ul>
					</div>
				</div>
				<div class="s-main-l">
							...
							<li>
								<a href="#">
									<div class="sc3f-ulc1">
										...
										<span class="ulc2">
											<p class="p18">部队名称</p>
											<p class="p14" style="margin-top: 10px!important;">部队类型</p>
											<p class="p14">粉丝数量</p>
											<p class="p14">所在地点：郑州</p>
											<p class="clearfloat"></p>
										</span>
										<span class="clearfloat"></span>
									</div>
									<div class="sc3f-ulc2">
										<p>部队介绍部队介绍部队介绍部队介绍部队介绍部队介绍部队介绍部队介绍部队介绍部队介绍部队介绍部部队介绍部队介介...</p>
									</div>
									<div class="clearfloat"></div>
								</a>
							</li>
