				...
				<div class="s-main-r">
					...
					<div class="bdsz">
						...
						<ul>
							...
							<li id="con-tjzp">
									<a rel="nofollow" href="?s=/Home/Mtbu/spglsp/id/<?php echo ($v["id"]); ?>">
									<h2>添加商品</h2>
								</a>
							</li>
						</ul>
				...
				<div class="s-main-l">
					<div class="con1">
						<div class="s-c-8f">
							...
							<div class="s-c-8f-2f rzjbxx">
								...
								<ul class="ul-r">
									...
									<input type="hidden" name="id" value="<?php echo ($v["id"]); ?>"/>
										<input type="text" name="charter" value="<?php echo ($v["charter"]); ?>" placeholder="请输入真实营业执照" class="gray-in" readonly="readonly"/>
									</li>
									<li>
										<input type="text" name="representative" value="<?php echo ($v["representative"]); ?>" placeholder="请输入真实法定代表人姓名" class="gray-in" readonly="readonly"/>
									</li>
									<li>
										<input type="text" name="shopname"  value="<?php echo ($v["shopname"]); ?>" class="gray-in" placeholder="请输入门店的简称、别称" readonly="readonly"/>
									</li>
									<li>
										<input type="text" name="address" id="address"   value="<?php echo ($v["address"]); ?>" class="white-in xz-city" readonly="readonly" placeholder="请选择" onclick="appendCity(this,'danxuan')" value="" data-value="" />
										<input type="text" name="xaddress" id="xaddress" value="<?php echo ($v["xaddress"]); ?>" class="white-in xxdz" placeholder="请填写详细地址（不超过18个字）" />
									</li>
									<li>
										<input type="text" name="tel" id="tel"  value="<?php echo ($v["tel"]); ?>" class="white-in lxdh" placeholder="请输入联系电话" />
									</li>
									<li>
										<input type="text" name="qq" value="<?php echo ($v["qq"]); ?>" class="white-in lxdh" placeholder="请输入QQ" />
									</li>
									<li class="parents">
									     <?php if($v[type]=='销售商'): ?><input type="radio" name = 'type'  value="销售商"  checked="checked" readonly="true"/> 销售商
                                      <?php else: ?>
                                      <input type="radio" name = 'type'  value="销售商"  readonly="true"/> 销售商<?php endif; ?>
                                     <?php if($v[type]=='租赁商'): ?><input type="radio" name = 'type'  value="租赁商"  checked="checked" readonly="true"/> 租赁商
                                      <?php else: ?>
                                      <input type="radio" name = 'type'  value="租赁商"  readonly="true"/>租赁商<?php endif; ?>
                                        <?php if($v[type]=='销售/租赁'): ?><input type="radio" name = 'type'  value="销售/租赁"  checked="checked" readonly="true"/>销售/租赁
                                      <?php else: ?>
                                      <input type="radio" name = 'type'  value="销售/租赁"  readonly="true"/> 销售/租赁<?php endif; ?>
                                        <?php if($v[type]=='婚车租赁'): ?><input type="radio" name = 'type'  value="婚车租赁"  checked="checked" readonly="true"/>婚车租赁
                                      <?php else: ?>
                                      <input type="radio" name = 'type'  value="婚车租赁"  readonly="true"/> 婚车租赁<?php endif; ?>
										<div class="clearfloat"></div>
									</li>
									<li style="height: 110px;">
										<textarea name="zysp" id="zysp" placeholder="请输入部队简介..."><?php echo ($v["zysp"]); ?></textarea>
									</li>
									<li>
										<select name="wangzhan"  id="city2" class="lj">
										 <option><?php echo ($v["wangzhan"]); ?></option >
											<option>淘宝</option>
											<option>天猫</option>
										</select>
										<input type="text" name="lianjie" value="<?php echo ($v["lianjie"]); ?>" class="white-in xxdz" placeholder="请输入链接地址" />
									</li>
								</ul>
							...
							<div class="clearfloat"></div>
							<input  id="jbxx" class="button-bc" style="text-align:center" onclick="tj()" value="保存">
							<!-- <button id="jbxx" class="button-bc">修改</button> -->
						</div>
					</div>
...
<html>
	...
	<script src="/matouPCS/Public/Home/js/upspimg.js"></script>
