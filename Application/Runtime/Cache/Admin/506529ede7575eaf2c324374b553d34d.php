...
<!--头部完结-->  
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <?php if(is_array($jarr)): $i = 0; $__LIST__ = $jarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><form action="/matouPCS/index.php/admin/Reward/usave" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <input id="date" type="text" class="date_picker" name="time" placeholder="<?php echo ($v["time"]); ?>" />
                                    
                                          <input type="hidden" name="psid" value="<?php echo ($v["psid"]); ?>"/>
                                        <input type="hidden" name="pubtime" value="<?php echo ($v["pubtime"]); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>活动地点：</th>
                                <td>
                                    <input class="common-text required" id="name" name="address" size="40" value="<?php echo ($v["address"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>电话：</th>
                                <td>
                                    <input class="common-text required" id="sex" name="tels" size="15" value="<?php echo ($v["tels"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>qq：</th>
                                <td>
                                    <input class="common-text required" id="age" name="qqs" size="15" value="<?php echo ($v["qqs"]); ?>" type="text">
                                </td>
                            </tr>
                            ...
                            <tr>
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="age" name="collect" size="15" value="<?php echo ($v["collect"]); ?>" type="text">
                                </td>
                            </tr>
                              <tr>
                                <th></th>
                                <td>
                                    ...
                                    <a href="/matouPCS/index.php/Admin/Reward"><input class="btn btn6"  value="返回"></a>
                                </td>
                            </tr>
                        </tbody></table>
