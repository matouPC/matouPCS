...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/think/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">部队中心</span></div>
        </div>
  ...
  <?php if(is_array($jarr)): $i = 0; $__LIST__ = $jarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><form action="/matouPCS/index.php/admin/Reward/usave1" method="post" id="myform<?php echo ($v["wid"]); ?>" name="myform" enctype="multipart/form-data">
                ...
                <div class="config-items">
                    <div class="config-title">
                        <h1><i class="icon-font">&#xe014;</i>关注详情</h1>
                    </div>
                        ...
                        <table width="100%" class="insert-tab">
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="" value="<?php echo ($v["address"]); ?>" size="40" name="age" class="common-text" readonly="true"></td>
                                ...
                                <tr>
                                    <th></th>
                                    <td>
                                         <a href="/matouPCS/index.php/Admin/Bdzx"><input type="button" value="返回上一级"  class="btn btn6"></a>
                                    </td>
                                </tr>
                        </table>
                    </div>
