...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">  
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/matouPCS/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">跳蚤市场管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/matouPCS/Admin/Flea/index" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/matouPCS/Admin/Flea/add"><i class="icon-font"></i>添加数据</a>
                   <a id="batchDel" href="javascript:void(0)"><input form="myform"  formaction="/matouPCS/Admin/Flea/bdel" 
                  ...
                  <td class="tc"><input name="ids[]" value="<?php echo ($v["fid"]); ?>"  class="check" type="checkbox"></td>
                          <td> <?php echo ($v["username"]); ?></td>
                           ...
                           <td> <?php echo ($v['type']=='1'?'求购':'闲置'); ?></td>
                            ...
                            <td>
                                <a class="link-update" href="/matouPCS/Admin/Flea/update?fid=<?php echo ($v["fid"]); ?>">修改内容</a>
                                  <?php if($v[type]=='2'): ?><a class="link-update" href="/matouPCS/Admin/Flea/updateimage?fid=<?php echo ($v["fid"]); ?>">图片管理</a><?php endif; ?>
