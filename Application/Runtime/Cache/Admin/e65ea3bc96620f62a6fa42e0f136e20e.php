...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/think/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">招聘大厅管理</span></div>
        </div>
        <div class="result-wrap">
  <?php if(is_array($jarr)): $i = 0; $__LIST__ = $jarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><form action="/matouPCS/index.php/admin/Recruit/usave1" method="post" id="myform<?php echo ($v["id"]); ?>" name="myform" enctype="multipart/form-data">
          
                <div class="config-items">
                    <div class="config-title">
                        <h1><i class="icon-font">&#xe014;</i>招聘详情</h1>
                    </div>
                    <div class="result-content">
                        <table width="100%" class="insert-tab">
                            <tr>
                                <th width="15%"><i class="require-red">*</i>招聘职位：</th>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="" value="<?php echo ($v["worktime"]); ?>" size="10" name="worktime" class="common-text">年</td>
                                </tr>
                                <tr>
                                    <th><i class="require-red">*</i>薪资：</th>
                                    <td><input type="text" id="" value="<?php echo ($v["price"]); ?>" size="10" name="price" class="common-text">元/天</td>
                                </tr>
                              
                                <tr>
                                    <th><i class="require-red">*</i>工作内容：</th>
                                    <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($v["content"]); ?></textarea></td>
                                </tr>
                                <tr>
                                    <th><i class="require-red">*</i>岗位要求：</th>
                                    <td><textarea name="work" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($v["work"]); ?></textarea></td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <td>
                                        <input type="hidden" value="" name="file">
                                        <a id="submit" onclick="tj(<?php echo ($v["id"]); ?>)"  class="btn btn-primary btn6 mr10">修改</a>
                                             <a class="btn btn-primary btn6 mr10"  onclick="sc(<?php echo ($v["id"]); ?>)">删除</a>
                                   <a href="/matouPCS/index.php/Admin/Recruit"><input type="button" value="返回上一级"  class="btn btn6"></a>
                                    </td>
                                </tr>
                        </table>
                    </div>
 ...
 function tj(id){
	// alert(id);
	 $.ajax({
	                 cache: true,
	                 type: "POST",
	                 url:"/matouPCS/index.php/Admin/Recruit/usave1/",
...
//	alert(id);
	if(confirm( '是否确定删除这条信息！')==true){
       	$.ajax({
       		...
       		url:"/matouPCS/index.php/Admin/Recruit/delete1/id/"+id,
