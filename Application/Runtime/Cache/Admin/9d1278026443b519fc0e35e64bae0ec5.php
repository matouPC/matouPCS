...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/think/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">留言详情</span></div>
        </div>
                ...
                <div class="config-items">
                    ...
                    <div class="result-content">
                        <table width="100%" class="insert-tab">
                            <tr>
                                <th width="15%"><i class="require-red">*</i>留言用户名：</th>
                                <td><input type="text" id="" value="<?php echo ($v["username"]); ?>" size="20" name="type" class="common-text"  readonly="true"></td>
                                   ...
                                   <tr>
                                    <th><i class="require-red">*</i>时间：</th>
                                                 <td><input type="text" id="" value="<?php echo ($v["ltime"]); ?>" size="20" name="type" class="common-text"  readonly="true"></td>
                                </tr>
                                
                            </tr>
                                   <tr>
                                    <th><i class="require-red">*</i>留言内容：</th>
                                    <td><textarea name="contents" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="5"  readonly="true"><?php echo ($v["contents"]); ?></textarea></td>
                                </tr>
                        <tr>
                                    <th></th>
                                    <td>
                                        <input type="hidden" value="" name="file">
                                               ...
                                               <a class="btn btn-primary btn6 mr10"  onclick="sc(<?php echo ($v["lid"]); ?>)">删除</a>
                    ...
                    <a href="/matouPCS/index.php/Admin/Liuyan"><input type="button" value="返回上一级"  class="btn btn6"></a>
<script type="text/javascript" src="/matouPCS/Public/Home/js/jquery-1.8.3.min.js"></script>            
 ...
 function sc(lid){
	...
	if(confirm( '是否确定删除这条信息！')==true){
       	$.ajax({
       		...
       		url:"/matouPCS/index.php/Admin/Liuyan/delete/id/"+lid,
