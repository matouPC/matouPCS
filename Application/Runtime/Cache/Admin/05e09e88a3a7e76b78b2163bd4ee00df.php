...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/matouPCS/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">应赏区管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/matouPCS/Admin/Due/index" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/matouPCS/Admin/Due/add"><i class="icon-font"></i>添加</a>
                       <a id="batchDel" href="javascript:void(0)"><input form="myform"  formaction="/matouPCS/Admin/Due/bdel" 
                           ...
                           <td> <?php echo ($v["username"]); ?> </td>
                            ...
                            <td><?php echo ($v["qqs"]); ?></td>
                             <td><?php echo ($v["skilled"]); ?></td>
                              ...
                              <td>
                              <a class="link-update" href="/matouPCS/Admin/Due/updateimage?did=<?php echo ($v["did"]); ?>">照片作品</a>
                              <a class="link-update" href="/matouPCS/Admin/Due/updatevideo?did=<?php echo ($v["did"]); ?>">视频作品</a>
                              </td>
                          
                            <td>
                                <a class="link-update" href="/matouPCS/Admin/Due/update?did=<?php echo ($v["did"]); ?>">修改内容</a>
