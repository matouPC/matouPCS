...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/matouPCS/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">应赏区管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/matouPCS/index.php/Admin/Due/index" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/matouPCS/index.php/Admin/Due/add"><i class="icon-font"></i>添加</a>
                       <a id="batchDel" href="javascript:void(0)"><input form="myform"  formaction="/matouPCS/index.php/Admin/Due/bdel" 
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($operarr)): $i = 0; $__LIST__ = $operarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                             <td class="tc"><input name="ids[]" value="<?php echo ($v["did"]); ?>"  class="check" type="checkbox"></td>
                           <td> <?php echo ($v["username"]); ?> </td>
                            ...
                            <td><?php echo ($v["qqs"]); ?></td>
                             <td><?php echo ($v["skilled"]); ?></td>
                              <td><?php echo (substr($v["content"],0,9)); ?>.</td>
                              <td>
                              <a class="link-update" href="/matouPCS/index.php/Admin/Due/updateimage?did=<?php echo ($v["did"]); ?>">照片作品</a>
                              <a class="link-update" href="/matouPCS/index.php/Admin/Due/updatevideo?did=<?php echo ($v["did"]); ?>">视频作品</a>
                              </td>
                          
                            <td>
                                <a class="link-update" href="/matouPCS/index.php/Admin/Due/update?did=<?php echo ($v["did"]); ?>">修改内容</a>
                                <a class="link-del"   onclick="shanchu(<?php echo ($v["did"]); ?>)">删除</a>
