...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
             <form action="/matouPCS/admin/Recruit/save" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
 
                            <tr>
                                <th><i class="require-red">*</i>工作地址：</th>
                                <td>
                                    <input class="common-text required" id="name" name="address" size="30" value="" type="text">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="age" name="rtel" size="12" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>qq：</th>
                                <td>
                                    <input class="common-text required" id="height" name="rqq" size="12" value="" type="text">
                                </td>
                            </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="height" name="remail" size="12" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>收藏数：</th>
                                <td><input class="common-text" name="collect" size="10" value="" type="text"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="/matouPCS/Admin/Recruit"><input class="btn btn6"  value="返回"></a>
                                </td>
                            </tr>
                        </tbody></table>
                </form>
