...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/matouPCS/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">招聘大厅管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/matouPCS/index.php/Admin/Recruit/index" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/matouPCS/index.php/Admin/Recruit/add"><i class="icon-font"></i>添加招聘</a>
                         <a id="batchDel" href="javascript:void(0)"><input form="myform"  formaction="/matouPCS/index.php/Admin/Recruit/bdel" 
                            ...
                            <td><?php echo (substr($v["address"],0,9)); ?></td>
                             ...
                             <td><?php echo ($v["remail"]); ?></td>
                              <td><?php echo ($v["collect"]); ?></td>
                                  <td>    <a class=" link-update" href="/matouPCS/index.php/Admin/Recruit/tem?rid=<?php echo ($v["rid"]); ?>">招聘详情</a></td>
                            <td>
                                <a class="link-update" href="/matouPCS/index.php/Admin/Recruit/update?rid=<?php echo ($v["rid"]); ?>">修改内容</a>
