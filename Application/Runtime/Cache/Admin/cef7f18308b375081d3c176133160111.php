...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/matouPCS/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">应聘区管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/matouPCS/Admin/Employ/index" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/matouPCS/Admin/Employ/add"><i class="icon-font"></i>添加</a>
                       <a id="batchDel" href="javascript:void(0)"><input form="myform"  formaction="/matouPCS/Admin/Employ/bdel" 
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($operarr)): $i = 0; $__LIST__ = $operarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                           ...
                           <td>
                         <a class="link-update" href="/matouPCS/Admin/Employ/updatework?id=<?php echo ($v["id"]); ?>">工作经历</a>   
                        <a class="link-update" href="/matouPCS/Admin/Employ/updateimage?id=<?php echo ($v["id"]); ?>">照片作品</a>   
                         <a class="link-update" href="/matouPCS/Admin/Employ/updatevideo?id=<?php echo ($v["id"]); ?>">视频作品</a>                  
                           
                           
                           </td>
                            <td>
                                <a class="link-update" href="/matouPCS/Admin/Employ/update?id=<?php echo ($v["id"]); ?>">修改内容</a>
