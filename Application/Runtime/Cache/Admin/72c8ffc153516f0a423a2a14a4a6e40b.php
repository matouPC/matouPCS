...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/matouPCS/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">部队中心管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/matouPCS/index.php/Admin/Bdzx/index" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($operarr)): $i = 0; $__LIST__ = $operarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                           ...
                           <td > <a class="link-update" href="/matouPCS/index.php/Admin/Bdzx/guanzhu?id=<?php echo ($v["uid"]); ?>">关注详情</a>
                                    <a class="link-update" href="/matouPCS/index.php/Admin/Bdzx/dongtai?id=<?php echo ($v["uid"]); ?>">个人动态</a>
                             </td>
