    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/matouPCS/Admin/Reward/index" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/matouPCS/Admin/Reward/add"><i class="icon-font"></i>添加悬赏</a>
                        <a id="batchDel" href="javascript:void(0)"><input form="myform"  formaction="/matouPCS/Admin/Reward/bdel" 
                        ...
                        <?php if(is_array($operarr)): $i = 0; $__LIST__ = $operarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td><?php echo ($v["data"]); ?></td>
                           ...
                           <td><?php echo (substr($v["content"],0,9)); ?>..</td>
                             ...
                             <td> <a class=" link-update" href="/matouPCS/Admin/Reward/tem?psid=<?php echo ($v["psid"]); ?>">悬赏详情</a></td>
                            <td>
                                <a class=" link-update" href="/matouPCS/Admin/Reward/update?psid=<?php echo ($v["psid"]); ?>">修改信息</a>    
