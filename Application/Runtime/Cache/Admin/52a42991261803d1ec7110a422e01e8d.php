    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/matouPCS/Admin/Force/index" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/matouPCS/Admin/Force/add"><i class="icon-font"></i>添加部队</a>
                       <a id="batchDel" href="javascript:void(0)"><input form="myform"  formaction="/matouPCS/Admin/Force/bdel" 
                            ...
                            <td id="phone<?php echo ($v["id"]); ?>"><?php echo ($v["tels"]); ?></td>
                             <td><?php echo ($v["qqs"]); ?></td>
                              ...
                              <td><?php echo ($v["collect"]); ?></td>
                               ...
                               <td><a  href="/matouPCS/Admin/Force/status?id=<?php echo ($v["uid"]); ?>">审核详情</a></td>
                               
                                 <td>   <a class="link-update" href="/matouPCS/Admin/Force/updateimages?id=<?php echo ($v["id"]); ?>">照片作品</a>
                              <a class="link-update" href="/matouPCS/Admin/Force/updatevideo?id=<?php echo ($v["id"]); ?>">视频作品</a>
                             </td>
                            <td>
                                <a class="link-update" href="/matouPCS/Admin/Force/update?id=<?php echo ($v["id"]); ?>">修改内容</a>
                                <a class="link-update" href="/matouPCS/Admin/Force/updateimage?id=<?php echo ($v["id"]); ?>">修改logo图</a>
