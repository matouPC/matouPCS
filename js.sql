...
--
-- Host: localhost
-- Generation Time: 2016-01-07 17:59:08
-- 服务器版本： 5.6.22
-- PHP Version: 5.5.21
...
INSERT INTO `js` (`id`, `name`, `addtime`) VALUES
...
(68, 'jQuery+ui自由拖动浮动层', 1429745750),
...
(96, 'javascript仿汽车之家焦点图', 1430551460),
(97, 'jQuery页面小型窗口预览', 1430578078),
(98, 'javascript白色简洁计算器', 1430620454),
(99, 'javascript仿qq签名', 1430647896),
(100, 'jSignature演示手动签名', 1430648890);
